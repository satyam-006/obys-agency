...
function cursorAnimation() {
  ...
  Shery.makeMagnet("#nav-part2 h4,#nav-part1 svg:nth-child(1)");
...
function footerAnimation() {
  ...
  var clutter = ""
  var clutter2 = ""
  document.querySelector("#content-div h1").textContent.split("").forEach(function (elem) {
    clutter += `<span>${elem}</span>`
  })
  document.querySelector("#content-div h1").innerHTML = clutter
  document.querySelector("#content-div h3").textContent.split("").forEach(function (elem) {
    clutter2 += `<span>${elem}</span>`
  })
  document.querySelector("#content-div h3").innerHTML = clutter2


  document.querySelector("#footer-text").addEventListener("mouseenter", function () {
    gsap.to("#content-div h1 span", {
      opacity: 0,
      stagger: 0.05
    })
    gsap.to("#content-div h3 span", {
      delay: 0.35,
      opacity: 1,
      stagger: 0.1
    })
